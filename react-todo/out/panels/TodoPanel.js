...
class TodoPanel {
    ...
    static render(extensionUri) {
        if (TodoPanel.currentPanel) {
            ...
            TodoPanel.currentPanel._panel.reveal(vscode_1.ViewColumn.One);
        }
        else {
